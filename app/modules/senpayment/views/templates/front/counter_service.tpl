        ...
        <div class="row product-container js-product-container" style="display: flex; flex-direction: column; align-items: center;">
            <div class="col-md-12">
                <div style="display: flex; flex-direction: column;">
                    ...
                    <div id="CounterService" class="counter-service" style="display: flex; flex-direction: column; background: white; width: 100%; outline: 2px solid #000; outline-offset: -1px;">
