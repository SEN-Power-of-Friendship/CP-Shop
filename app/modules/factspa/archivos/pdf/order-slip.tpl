	...
	<tr>
		...
		<td style="width: 33%;  text-align: right; vertical-align: middle; padding-left: 15pt">
			<table>
				...
				<tr>
					<td style="font-size: 14pt; font-weight: bold; color: {if Configuration::get('FSPA_color')}{Configuration::get('FSPA_color')}{else}#000000{/if}; text-align: right;">{l s='Factura Rect.' pdf='true'}</td>
				</tr>
		...
		<td style="text-align: right">
			<table style="width: 100%; font-size: 8pt; vertical-align:central; border-collapse: separate; border-spacing: 1.4pt;">
			    <tr style="line-height: 1.6pt;  font-size: 9pt; text-align:left; vertical-align:top; background-color: #F2F2F2;">
					<td colspan="2" style="padding-top: 7pt; padding-bottom: 7pt; color:#000000;">{l s='Order Ref.:' pdf='true'} {$order->getUniqReference()} | {l s='Order id:' pdf='true'}{$order->id} | {l s='Factura rectificada:' pdf='true'}{if $rectificada}{$rectificada}{else}{Configuration::get('PS_INVOICE_PREFIX',Context::getContext()->language->id)}{$order->invoice_number|string_format:"%06d"}{/if}
					</td>
				</tr> 
        		...
        		<tr style="background-color: {if Configuration::get('FSPA_color')}{Configuration::get('FSPA_color')}{else}#000000{/if}; line-height: 1.7pt; font-size: 12pt; color: {Configuration::get('FSPA_textColor')}; text-align:center">
					<td colspan="6" style="padding-top: 7pt; padding-bottom: 7pt;">{l s='Detalles' pdf='true'}</td>
				</tr>                
                ...
                <tr style="line-height:4px;">
	                ...
	                {if Configuration::get('FSPA_details') == 1}
	                    ...
	                    <td style="text-align: center; background-color: {if Configuration::get('FSPA_color')}{Configuration::get('FSPA_color')}{else}#000000{/if}; color: {Configuration::get('FSPA_textColor')}; padding-left: 10px;font-size: 7pt; width: 10%">{l s='Dto.' pdf='true'}</td>
	                {/if}
					...
					<td style="background-color: {if Configuration::get('FSPA_color')}{Configuration::get('FSPA_color')}{else}#000000{/if}; color: {Configuration::get('FSPA_textColor')}; text-align: right; padding-right:2pt;font-size: 9pt; width: {if Configuration::get('FSPA_details') == 1}13%{else}15%{/if}">{l s='Total' pdf='true'}</td>
				</tr>
				...
				{cycle values='#FFF,#DDD' assign=bgcolor}
					<tr style="line-height:5px;background-color:{$bgcolor};">
		                ...
		                <td style="text-align: right; width: 10%">{$order_detail.product_quantity}</td>

						<td style="width: 15%; text-align: right;  width: {if Configuration::get('FSPA_details') == 1}13%{else}15%{/if}; font-size:9pt; color:#404040">-{displayPrice currency=$order->id_currency price=$order_detail.total_price_tax_excl}</td>
					</tr>
				{/foreach}
