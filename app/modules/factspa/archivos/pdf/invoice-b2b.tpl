	...
	<tr>
		...
		<td style="width: 33%;  text-align: right; vertical-align: middle; padding-left: 15pt">
			<table>
				...
				<tr>
					<td style="font-size: 11pt; font-weight: bold; color: {if Configuration::get('FSPA_titleColor')}{Configuration::get('FSPA_titleColor')}{else}#000000{/if}; text-align: right;">{l s='Factura' pdf='true'}</td>
				</tr>
			...
			<table style="width: 100%; font-size: 8pt; vertical-align:central; border-collapse: separate; border-spacing: 1.4pt;">
                ...
                <tr style="line-height:4px;">
                    ...
                    {if Configuration::get('FSPA_details') == 1}
	                    <td style="text-align: center; background-color: {if Configuration::get('FSPA_color')}{Configuration::get('FSPA_color')}{else}#000000{/if}; color: {Configuration::get('FSPA_textColor')}; padding-left: 10px;font-size: 7pt; width: 10%">{l s='Precio sin descuento' pdf='true'}</td>
...
<table style="width:100%; color:#404040">
	...
	<!-- END CART RULES -->
	<tr style="border-collapse:separate; border-spacing: 4.5pt; font-size:10pt; color:#404040; line-height:2pt">
		<td style="width:75%; text-align:right">{l s='Shipping Cost' pdf='true'} - {l s='Carrier:' pdf='true'} {$order_invoice->getCarrier($order_invoice->id)->name}</td>
		<td style="width:10%"></td>
		<td style="width:15%; text-align:right">
		{if $tax_excluded_display}
